...
object MTASubwayTripUpdatesMSKWithHudi extends Serializable {
  def main(args: Array[String]) { 
    ...
    val spark = SparkSession.builder().appName("MTA Trip Streaming ETL for Amazon MSK with Hudi").enableHiveSupport().getOrCreate()
	...
	val trip_update_schema = new StructType()
        ...
        def myFunc( batchDF:DataFrame, batchID:Long ) : Unit = {
            ...
            batchDF.write.format("org.apache.hudi")
                ...
                .save("s3://vasveena-test-demo/reinvent/streaming_etl_msk_with_hudi_output/")
